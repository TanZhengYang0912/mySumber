...
class LocalAccountProfiles extends Table
    with TableInfo<LocalAccountProfiles, LocalAccountProfilesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  LocalAccountProfiles(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> userId = GeneratedColumn<String>(
      'user_id', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: true,
  ...
  @override
  LocalAccountProfilesData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return LocalAccountProfilesData(
      userId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}user_id'])!,
  ...
  @override
  LocalAccountProfiles createAlias(String alias) {
    return LocalAccountProfiles(attachedDatabase, alias);
  }
...
class LocalAccountProfilesData extends DataClass
    implements Insertable<LocalAccountProfilesData> {
  final String userId;
  ...
  const LocalAccountProfilesData(
      {required this.userId,
  ...
  factory LocalAccountProfilesData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return LocalAccountProfilesData(
      userId: serializer.fromJson<String>(json['userId']),
  ...
  LocalAccountProfilesData copyWith(
          {String? userId,
          String? fullName,
          String? email,
          String? role,
  ...
  LocalAccountProfilesData copyWithCompanion(
      LocalAccountProfilesCompanion data) {
    return LocalAccountProfilesData(
      userId: data.userId.present ? data.userId.value : this.userId,
  ...
  @override
  String toString() {
    return (StringBuffer('LocalAccountProfilesData(')
          ..write('userId: $userId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is LocalAccountProfilesData &&
          other.userId == this.userId &&
...
class LocalAccountProfilesCompanion
    extends UpdateCompanion<LocalAccountProfilesData> {
  final Value<String> userId;
  ...
  LocalAccountProfilesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
        ...
        status = Value(status),
        verifiedAt = Value(verifiedAt);
  static Insertable<LocalAccountProfilesData> custom({
    Expression<String>? userId,
...
class DatabaseAtV2 extends GeneratedDatabase {
  ...
  late final LocalAccountProfiles localAccountProfiles =
      LocalAccountProfiles(this);
